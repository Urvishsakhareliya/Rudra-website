...
let ditheringTexture = createTextureAsync("BACK");
...
document.getElementById("page").addEventListener("mouseover", () => {
  pointers[0].down = true;
  pointers[0].color = generateColor();
});

document.getElementById("fff").addEventListener("mousemove", () => {
  pointers[0].moved = pointers[0].down;
});

document.getElementById("fff").addEventListener("mouseover", () => {
  pointers[0].down = true;
  pointers[0].color = generateColor();
});

function generateColor() {
  let c = HSVtoRGB(1.6, 1.0, 1.0);
  c.r *= 0.1;
  c.g *= 0.1;
  c.b *= 0.1;
  return c;
